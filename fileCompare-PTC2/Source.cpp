	...
	namespace fileCompare {
		...
		void Source(array<String^>^ args) {
			...
			StreamReader^ reader1 = gcnew StreamReader(	//C++ PTC2 output
				"C:\\Hogeschool van Amsterdam\\SWARCO\\SwarcoStage\\CCOL-ITC2 opdracht\\Ccol\\Out2.PTC2");
			StreamReader^ reader2 = gcnew StreamReader(	//C# PTC2 output
				"C:\\Hogeschool van Amsterdam\\SWARCO\\SwarcoStage\\CCOL-ITC2 opdracht\\Ccol\\Out3.PTC2");
			int regelNummer = 0;
			bool changed = false;
			String^ makeWorkID = "";
